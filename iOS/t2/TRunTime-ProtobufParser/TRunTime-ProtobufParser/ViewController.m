...
- (IBAction)normalParse:(UIButton *)sender {
    ...
    ProtoAlbum *protoAlbum = [ProtoAlbum modelWithDictionary:dict];
...
- (IBAction)customParse:(UIButton *)sender {
    ...
    ProtoCustomAlbum *protoAlbum = [ProtoCustomAlbum modelWithDictionary:dict];
...
- (IBAction)containerParse:(UIButton *)sender {
    ...
    ProtoContainerAlbum *protoAlbum = [ProtoContainerAlbum modelWithDictionary:dict];
    NSMutableArray *albums = [NSMutableArray array];
    for (int i = 0; i < 3; i++) {
        [albums addObject:[ProtoAlbum modelWithDictionary:[self normalSourceDictionary]]];
    }
