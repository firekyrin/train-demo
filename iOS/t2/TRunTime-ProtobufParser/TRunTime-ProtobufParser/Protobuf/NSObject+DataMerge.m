...
#define DefaultIgnoreProperties @[@"debugDescription", @"description", @"superclass", @"hash"]
...
+ (instancetype)instanceWithObject:(id)object {
    return [self instanceWithObject:object ignoreProperties:nil mapKeyValues:nil];
}

+ (instancetype)instanceWithObject:(id)object ignoreProperties:(NSArray<NSString *> *)ignoreProperties {
    return [self instanceWithObject:object ignoreProperties:ignoreProperties mapKeyValues:nil];
}

+ (instancetype)instanceWithObject:(id)object mapKeyValues:(NSDictionary<NSString *,NSString *> *)mapKeyValues {
    return [self instanceWithObject:object ignoreProperties:nil mapKeyValues:mapKeyValues];
}
...
+ (instancetype)instanceWithObject:(id)object ignoreProperties:(NSArray<NSString *> *)ignoreProperties mapKeyValues:(NSDictionary<NSString *, NSString *> *)mapKeyValues {
    ...
    [instance setupWithObject:object ignoreProperties:ignoreProperties mapKeyValues:mapKeyValues];
    
    return instance;
}

- (void)setupWithObject:(id)object {
    [self setupWithObject:object ignoreProperties:nil mapKeyValues:nil];
}

- (void)setupWithObject:(id)object ignoreProperties:(NSArray<NSString *> *)ignoreProperties {
    [self setupWithObject:object ignoreProperties:ignoreProperties mapKeyValues:nil];
}

- (void)setupWithObject:(id)object mapKeyValues:(NSDictionary<NSString *, NSString *> *)mapKeyValues {
    [self setupWithObject:object ignoreProperties:nil mapKeyValues:mapKeyValues];
}
...
- (void)setupWithObject:(id)object ignoreProperties:(NSArray<NSString *> *)ignoreProperties mapKeyValues:(NSDictionary<NSString *,NSString *> *)mapKeyValues {
    ...
    if (properties != nil) {
        for (HHPropertyInfo *property in properties) {
            [self setValueWithProperty:property object:object ignoreProperties:ignoreProperties mapKeyValues:mapKeyValues];
        }
    }
    else {
...
- (void)setValueWithProperty:(HHPropertyInfo *)property object:(id)object ignoreProperties:(NSArray<NSString *> *)ignoreProperties mapKeyValues:(NSDictionary<NSString *, NSString *> *)mapKeyValues {
    if ([ignoreProperties containsObject:property->_name]) {
        return;
    }
